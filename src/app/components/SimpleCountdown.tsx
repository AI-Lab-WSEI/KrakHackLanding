  ...
  const renderCountdown = () => {
    ...
    switch (phase) {
      case 'recruitment':
        ...
        colorClass = 'from-purple-400 via-cyan-400 to-blue-500';
      ...
      case 'hackathon':
        ...
        colorClass = 'from-orange-400 via-red-500 to-pink-600';
      ...
      <div className="text-center space-y-6">
        <div className="relative pt-4 pb-8">
          <div className="relative h-2 bg-white/5 rounded-full overflow-visible">
            ...
            <motion.div
              className="absolute top-1/2 -translate-y-1/2 h-5 w-5 bg-white rounded-full z-20 shadow-[0_0_20px_#fff]"
              ...
              return (
                ...
                >
                  <div className="absolute bottom-full mb-6 opacity-0 group-hover/tooltip:opacity-100 transition-all duration-300 pointer-events-none w-48 z-50 translate-y-2 group-hover/tooltip:translate-y-0">
                    <div className="bg-indigo-950/95 border border-white/20 p-4 rounded-2xl backdrop-blur-2xl shadow-2xl text-[12px]">
          ...
          <div className="flex gap-4 md:gap-8 justify-center">
            {[
              ...
              <div key={i} className="flex flex-col items-center min-w-[80px] relative group/num">
                ...
                <motion.div 
                  className={`text-5xl md:text-6xl font-black bg-gradient-to-b ${colorClass} bg-clip-text text-transparent drop-shadow-2xl relative z-10`}
                ...
                <div className="text-[10px] text-indigo-300 font-black uppercase tracking-[0.3em] mt-3 relative z-10 opacity-80">{t.l}</div>
              </div>
            ))}
          </div>
        </div>
  ...
  return (
    <Link to="/timer" className="block">
      <motion.div 
        ...
        className="max-w-3xl mx-auto relative p-8 md:p-12 rounded-[3rem] border border-white/10 shadow-2xl overflow-visible transition-all duration-300 cursor-pointer group/container"
        style={{
      ...
      >
        <div className="absolute inset-0 bg-indigo-900/10 z-0 rounded-[3rem] group-hover/container:bg-indigo-900/20 transition-colors duration-300" />
